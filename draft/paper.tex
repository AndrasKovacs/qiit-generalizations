...
$\llb\Gamma\rrb_{\bS}$. E.g.\, $\llb\NatSig\rrb_{\bS}$ yields a left-nested
$\Sigma$-type of pointed sets with an endofunction. Also, $\llb\Gamma\rrb_{\bM}$
extends $\llb\Gamma\rrb_{\bS}$ to an flCwF of $\Gamma$-algebras.
\end{definition}
...
\begin{alignat*}{3}
  & \Con_{\bT}\,\ulGamma &&:\equiv \Sub\,\ulOmega\,\ulGamma \ra \llb\ulGamma\rrb_{\bS}\\
  & \Sub_{\bT}\,\Gamma\,\Delta\,\ulsigma &&:\equiv (\ulnu : \Sub\,\ulOmega\,\ulGamma)
  \ra \Delta\,(\ulsigma\circ\nu) \simeq \llb\ulsigma\rrb_{\bS}\,(\Gamma\,\ulnu)\\
  & \Ty_{\bT}\,\Gamma\,\ulA &&:\equiv (\ulnu : \Sub\,\ulOmega\,\ulGamma) \ra
    \Tm\,\ulOmega\,(\ulA[\ulnu]) \ra \llb\ulA\rrb_{\bS}\,(\Gamma\,\ulnu)\\
  & \Tm_{\bT}\,\Gamma\,A\,\ult &&:\equiv (\ulnu : \Sub\,\ulOmega\,\ulGamma)\ra
    \llb\ulA\rrb_{\bS}\,\ulnu\,(\ult[\ulnu]) \simeq_{\id} \llb\ult\rrb_{\bS} (\Gamma\,\ulnu)
\end{alignat*}

Above, the $\simeq$ in the definition of $\Sub_{\bT}$ is a context isomorphism
in $\llb\ulDelta\rrb_{\bM}$, which is the flCwF of $\ulDelta$-algebras. The
$\simeq_{\id}$ in $\Ty_{\bT}$ is a vertical context isomorphism in the displayed
flCwF given by $\llb\ulA\rrb_{\bM}$.

So far, the underlying sets in $\bT$ are similar to what was given in
...
\begin{alignat*}{3}
  & \U_{\bT} : (\ulnu : \Sub\,\ulOmega\,\ulGamma)(\ult : \Tm\,\ulOmega\,\U)\ra
              \Set_{j+1}\\
  & \U_{\bT}\,\ulnu\,\ult :\equiv \Tm\,\ulOmega\,(\El\,\ult)\\
  & \El_{\bT}\,a : (\ulnu : \Sub\,\ulOmega\,\ulGamma)
             (\ult : \Tm\,\ulOmega\,(\El\,(\ula[\ulnu])))\ra
              \llb\ula\rrb_{\bS}\,(\Gamma\,\ulnu)\\
  & \El_{\bT}\,a\,\ulnu\,\ult :\equiv (a\,\ulnu)\,\ult
\end{alignat*}
...
\[
  a\,\ulnu : \U_{\bT}\,\ulnu\,(\ula[\ulnu]) \simeq_{\id}
                 \llb\ula\rrb_{\bS}\,(\Gamma\,\ulnu)
\]
hence
\[
...
\[
  \Pii_{\bT}\,a\,B\,\ulnu\,\ult :\equiv \lambda\,\alpha.\,
...
\begin{alignat*}{3}
  & \Piinf_{\bT}\,A\,b\,\ulnu : \Tm\,\ulOmega\,(\El\,(\Piinf\,A\,(\lambda\,\alpha.\,(b\,\alpha)[\ulnu])))\\
  & \hspace{4.2em}\simeq_{\id} ((\alpha : A) \ra \llb\alpha\rrb_{\bS}\,(\Gamma\,\ulnu))
\end{alignat*}
...
\begin{alignat*}{3}
  & \Id_{\bT}\,a\,t\,u\,\ulnu : \Tm\,\ulOmega\,(\El\,(\Id\,(\ula[\ulnu])\,(\ult[\ulnu])\,(\ulu[\ulnu]))\\
  & \hspace{4.2em}\simeq_{\id} (\llb\ult\rrb_{\bS}\,(\Gamma\,\ulnu) =   \llb\ulu\rrb_{\bS}\,(\Gamma\,\ulnu))
\end{alignat*}

We omit the rest of the definition of $\bT$. The interpretations of equations in
