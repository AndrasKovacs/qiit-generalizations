...
%% We use extensional type theory as metatheory, extended with two features:
%% cumulative universes and a limited form of universe polymorphism.

%% The extensions are used to conveniently talk about large elimination and
%% algebras at different universe levels. For example, consider natural number
%% algebras at level $i$, given as the $\Sigma$-type $NatAlg_i :\equiv(Nat :
...
%% family of types. Hence, we would like to

%% Cumulativity is used to reduce bureaucratic overhead of
%% handling algebras at different universe levels. For a simple example, consider
%% natural number algebras at level $i$, given as the $\Sigma$-type $NatAlg_i
...
%% $Nat$-indexed family of types.


%% We are working in a variant of extensional type theory with cumulative
%% universes, abbreviated as cETT.
