...
We use Sterling's cumulative algebraic type theory \cite{sterling2019algebraic} as basis for our metatheory. \todo{REASONS}
...
\begin{enumerate}
  ...
  \item Constant families. This includes a type former $\Kfam : \Con \ra
    ...
    natural in $\Gamma$. We have $\lamK : \Sub\,\Gamma\,\Delta \ra
    \Tm\,\Gamma\,(\Kfam\,\Delta)$ and $\appK : \Tm\,\Gamma\,(\Kfam\,\Delta)
    \ra \Sub\,\Gamma\,\Delta$ as its components.  The idea is that
    $\Kfam\,\Delta$ is a representation of $\Delta$ as a type in any
    context. Clairambault and Dybjer called constant families ``democracy'' in
...
\begin{definition}[Type categories, c.f.\ \cite{clairambault2014biequivalence}] For each $\Gamma : \Con$, there is a category
...
\begin{definition} A weak flCwF morphism $\boldsymbol{\sigma : \Sub\,\Gamma\,\Delta}$ is a functor between underlying categories, which additionally maps types to types and terms to terms, and satisfies the following:
  \begin{enumerate}
...
:
\bsigma\,(\Gamma\,\ext\,A)\,\simeq\,\bsigma\,\Gamma\,\ext\,\bsigma\,A$.

%% We do not require preservation of fl-structure, because the above conditions already insure that.

\begin{theorem} Every $\boldsymbol{\sigma : \Sub\,\Gamma\,\Delta}$ preserves fl-structure up to type isomorphism. That is, we have isomorphisms
\begin{alignat*}{3}
...
verification that $\bsigma$ preserves term and substitution formers.
\end{proof}

\subsection{Identity and Composition}

%% $\bid : \bSub\,\bGamma\,\bGamma$ is defined in the obvious way, with $\bid
%% For composition
